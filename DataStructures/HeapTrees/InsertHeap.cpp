#include <iostream>
#include <vector>
// this function inserts one element into the heap

// the file 02_CreateHeap.cpp will create the heap from scratch - in-place
// creation
using namespace std;

// Lecture based
void InsertA(int A[], int n)
{ // n is the index of the newest stored element (i.e. the last element)
    int i = n;
    int temp = A[n];
    // compare each element with the parent (i/2)
    while (i > 0 && temp > A[i % 2 == 0 ? (i / 2) - 1 : i / 2])
    { // parent is either i/2 or i/2-1
